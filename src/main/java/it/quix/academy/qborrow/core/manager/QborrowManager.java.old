...
public class QborrowManager {
    ...
    @Transactional(readOnly = true)
    public List<Prestito> getPrestitoListBySoggetto(String beneficiario_username) {
        List<Prestito> list = daoFactory.getPrestitoDAO().getPrestitoListByBeneficiario(beneficiario_username);
        return list;
    }
     ...
     */
    @Transactional(readOnly = true, rollbackFor = { QborrowException.class })
    public Prestito getPrestito(String beneficiario_username, Integer oggettoPrestato_id) throws DAOFinderException {
        Prestito prestito = null;
        prestito = daoFactory.getPrestitoDAO().get(beneficiario_username, oggettoPrestato_id);
        return prestito;
    }
    ...
    public Prestito savePrestito(Prestito prestito, boolean validate) throws QborrowException, ValidationException {
        ...
        if (prestito.getBeneficiario() == null && prestito.getOggettoPrestato() == null) {
     ...
     */
    @Transactional(rollbackFor = { QborrowException.class })
    public void deletePrestito(String beneficiario_username, Integer oggettoPrestato_id) throws QborrowException {
        try {
            daoFactory.getPrestitoDAO().delete(beneficiario_username, oggettoPrestato_id);
        } catch (DAODeleteException e) {
