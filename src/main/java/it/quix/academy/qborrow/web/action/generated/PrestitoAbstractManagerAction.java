...
public class PrestitoAbstractManagerAction extends QborrowManagerAction {
    ...
    public String edit() {
        ...
        try {
            prestito = getQborrowManager().getPrestito(prestito.getBeneficiario_username(), prestito.getOggettoPrestato_id());
    ...
    public String delete() {
        try {
            getQborrowManager().deletePrestito(prestito.getBeneficiario_username(), prestito.getOggettoPrestato_id());
            return manageOkMessage();
        } catch (Exception e) {
