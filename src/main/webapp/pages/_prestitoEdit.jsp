...
<form name="forms.prestitoEditForm" novalidate>
	<div class="box box-framework" >
		...
		<div class="box-body">
			<div class="qrow">		
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12" ng-class="{'qhas-error': forms.prestitoEditForm.beneficiario.$invalid}">
					<label for="beneficiario"><s:text name="prestito.edit.beneficiario"/>*</label>
					<span class="quix-popup-search-field">      
		              	<div class="quix-popup-search-field-container">
			              	<div>
			              		<div class="quix-popup-search-field-label">{{scopeController.selectedRow.beneficiario_description}}</div>
			             		<div class="quix-popup-search-field-icon">
									<i class="fa fa-times fa-lg" ng-click="qxResetPopupField(scopeController.selectedRow, 'beneficiario')"></i>
			             		</div>
			             		<div class="quix-popup-search-field-icon">
									<i class="fa fa-search fa-lg" ng-click="openPopupField('Soggetto', scopeController.selectedRow, 'beneficiario', 'username', 'username')"></i>
			             		</div>
			             	</div>
		              	</div>  
		           </span>
					<div ng-messages="forms.prestitoEditForm.beneficiario.$error" role="alert">
