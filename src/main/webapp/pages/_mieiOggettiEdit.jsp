	...
	<div class="box box-framework">
		...
		<div class="box-body">
			...
			<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
				...
				<label for="titolo"><s:text name="oggetto.edit.titolo" /></label> <input
					type="text" ng-model="scopeController.selectedRow.titolo"
			...
			<div class="qrow">
				...
				<%-- <div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
					ng-class="{'qhas-error': forms.oggettoEditForm.dataUltimaModifica.$invalid}">
					<label for="dataUltimaModifica"><s:text
							name="oggetto.edit.dataUltimaModifica" />*</label>
					<div class="qdropdown">
						<a class="qdropdown-toggle" id="dropdown2" role="qbutton"
							data-toggle="qdropdown" data-target="#" href="#">
							<div class="qinput-group">
								<input type="text" name="dataUltimaModifica"
									id="dataUltimaModifica"
									class="qform-control box-input-calendar"
									data-ng-model="scopeController.selectedRow.dataUltimaModifica"
					...
					<div ng-messages="forms.oggettoEditForm.dataUltimaModifica.$error"
						role="alert">
						<div ng-message="notNull">
							<s:text name="error.notNull" />
						</div>
			...
			<div class="qcol-md-6 qcol-sm-6 qcol-xs-12"
				...
				<label for="beneficiario"><s:text
						name="prestito.edit.beneficiario" /></label> <input type="text"
					ng-model="scopeController.beneficiario" id="beneficiario"
					name="beneficiario" class="qform-control" />
					...
					<a class="qdropdown-toggle" id="dropdown2" role="qbutton"
						...
						<div class="qinput-group">
							<input type="text" name="dataScadenza" id="dataScadenza"
								class="qform-control box-input-calendar"
								data-ng-model="scopeController.dataScadenza" presetDate="true"
								dateformat="DD/MM/YYYY"> <span
								class="qinput-group-addon"><i class="fa fa-calendar"></i></span>
						</div>
					</a>
					<ul class="qdropdown-menu" role="qmenu" aria-labelledby="dLabel">
						<datetimepicker data-ng-model="scopeController.dataScadenza"
							data-datetimepicker-config="{ minView:'day', modelType: 'Date' }" />
					</ul>
				</div>
					...
					<a class="qdropdown-toggle" id="dropdown2" role="qbutton"
						...
						<div class="qinput-group">
							<input type="text" name="dataPestito" id="dataPrestito"
								class="qform-control box-input-calendar"
								data-ng-model="scopeController.dataPrestito" presetDate="true"
								dateformat="DD/MM/YYYY"> <span
								class="qinput-group-addon"><i class="fa fa-calendar"></i></span>
						</div>
					</a>
					<ul class="qdropdown-menu" role="qmenu" aria-labelledby="dLabel">
						<datetimepicker data-ng-model="scopeController.dataPrestito"
							data-datetimepicker-config="{ minView:'day', modelType: 'Date' }" />
					</ul>
				</div>
