	...
	<nav class="qnavbar qnavbar-default" role="navigation">
		...
		<div class="qcollapse qnavbar-collapse"
			...
			<ul class="qnav qnavbar-nav">
				<li class="active"><a class="framework-sidebar-menu-element-link" href="<s:property value="#homeUrl" escape="false" />">
			&nbsp;<s:text name="menu.home" />
		</a></li>
				<li><a class="framework-sidebar-menu-element-link" href="<s:property value="#mieiOggettiUrl" escape="false" />">
			mieiOggetti
		</a></li>
				<li class="active"><a class="framework-sidebar-menu-element-link" href="<s:property value="#oggettoUrl" escape="false" />">
			oggetto
		</a></li>
		<li class="active"><a class="framework-sidebar-menu-element-link" href="<s:property value="#prestitoUrl" escape="false" />">
			prestito
		</a></li>
		<li class="active"><a class="framework-sidebar-menu-element-link" href="<s:property value="#soggettoUrl" escape="false" />">
			soggetto
		</a></li>
