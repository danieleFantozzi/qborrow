	...
	<div class="box box-framework" >
		...
		<div class="box-body">
			...
			<div class="qrow">		
				...
				<div class="qcol-md-6 qcol-sm-6 qcol-xs-12" ng-class="{'qhas-error': forms.soggettoEditForm.dataCompleanno.$invalid}">
					<label for="dataCompleanno"><s:text name="soggetto.edit.dataCompleanno"/>*</label>
						<div class="qdropdown">
							<a class="qdropdown-toggle" id="dropdown2" role="qbutton" data-toggle="qdropdown" data-target="#" href="#">
								<div class="qinput-group">
