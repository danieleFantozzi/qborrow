	...
	<div class="box box-framework">
		...
		<div class="box-body qfade " ng-show="filtriEspansi" ng-cloak>
			<div class="qrow">
				...
				<div class="qcol-xs-12 qcol-sm-12 qcol-md-6" ng-class="{'qhas-error': forms.oggettoListForm.isInPrestito.$invalid}">
				<label for="categoria"><s:text name="oggetto.search.isInPrestito"/>:</label>
				<select id="isInPrestito" class="qform-control" ng-model="scopeController.search.isInPrestito">
			...
			<span class="dropdown" style="display:table-cell;height:40px;width:40px;text-align: center; vertical-align: middle; margin: 2px;">
				...
				<ul class="qdropdown-menu qdropdown-menu-right" ng-show="openOrderMenu" style="display: block;"> 											
					<li style="padding: 10px;">
						<s:text name="oggetto.list.order.id"/>
